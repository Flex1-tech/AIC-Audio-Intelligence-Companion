...
class ObsidianColors:
    ...
    SURFACE_DARK = "#161922"  # Card Surface
    SURFACE_ELEVATED = "#1E2330"  # Elevated Container / Dialog
    ...
    # Typographie & Icônes
    TEXT_PRIMARY = "#F9FAFB"  # Pure Warm White
    TEXT_SECONDARY = "#9CA3AF"  # Slate Gray
    TEXT_MUTED = "#6B7280"  # Darker Muted Steel
