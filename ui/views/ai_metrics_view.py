                    ...
                    ft.Row(
                        [
                            ...
                            self._build_card(
                                ...
                                "LanceDB Active",
                                ft.Icons.STORAGE,
                                ObsidianColors.ACCENT_CYAN,  # Brand Cyan for Vector DB
                            ),
                            self._build_card(
                                "Embeddings en Cache",
                                f"{app_state.total_embeddings_in_db} morceaux",
                                ft.Icons.GRID_VIEW,
                                ObsidianColors.ACCENT_CYAN,  # Brand Cyan for AI Cache
                            ),
                        ],
                        spacing=Spacing.MD,
                    ),
                    ...
                    content=ft.Row(
                        [
                            ...
                            ft.Text(
                                ...
                                size=11,
                                weight=ft.FontWeight.BOLD,
                                color=ObsidianColors.ACCENT_CYAN,  # Brand Cyan for AI engine log tag
                            ),
                            ft.Text(
                                log.description,
                                size=12,
